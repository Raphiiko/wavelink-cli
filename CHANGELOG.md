...
### Changed
- Updated to support Wave Link 3.0 Beta Update 4.
- Updated `@raphiiko/wavelink-ts` dependency to `^1.3.0`.

### Fixed
- Fixed main output device detection in `output list` command.

## [0.0.6] - 2026-01-12

### Added
- Support for using device/channel names in addition to IDs for all commands (case-insensitive).
